...
Pod::Spec.new do |s|
  s.name             = 'CaamDauViewModel'
  s.version          = '2.0.0'
  s.summary          = 'CaamDau 系列产品：自定义导航栏.'
  s.description      = <<-DESC
  ...
  s.source           = { :git => 'https://github.com/CaamDau/ViewModel.git', :tag => s.version }
  ...
  s.subspec 'Core' do |core|
    core.source_files = 'ViewModel/Core/**/*.{swift}'
    core.dependency 'CaamDauForm'
  end
  
  s.subspec 'BaseUI' do |bui|
    bui.source_files = 'ViewModel/BaseUI/**/*.{swift}'
    bui.dependency 'CaamDauViewModel/Core'
    bui.dependency 'CaamDauTopBar'
    bui.dependency 'CaamDauRefresh'
    bui.dependency 'CaamDauPopGesture'
